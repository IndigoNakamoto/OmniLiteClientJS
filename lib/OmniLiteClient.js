...
/**
 * Extend the basic Litecoin Client, 'Litecoin' by 'freewil' and add promises.
 * Code is based upon (copied from) the litecoin-promise NPM module, but extensible so we can
